...
export const LIGHT_ROLES = {
  ...
  'primary-text': { source: 'color',   shade: '600' },
...
export const DARK_ROLES = {
  ...
  'primary-text': { source: 'color', shade: '500' },  // colored text/links on dark surface
...
export function checkWCAG(tokens) {
  const pairs = [
    ...
    ['text', 'primary'],   // white text on primary fill (button)
  ];
  const wcag = {};
